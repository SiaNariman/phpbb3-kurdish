...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'	=> 'Number of minutes, hours or days between the last post to a topic and the ability to bump this topic.نرخکە بکە بە 0 بۆ ئەوەی ناچالاک بێت',
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'کەمترین ژمارەی نووسە کە بەکارهێنەر پێویستە بینووسێت لە پەیام یان پەیامێکی تایبەتیدا.',
	'POSTING'	=> 'پەیام ناردن',
...
'ACP_VC_SETTINGS_EXPLAIN'				=> 'Here you can select and configure plugins, which are designed to block automated form submissions by spambots. These plugins typically work by challenging the user with a <em>CAPTCHA</em>, a test which is designed to be difficult for computers to solve.',
	...
	'COOKIE_DOMAIN'	=> 'دۆمەینی کووکی',
	'COOKIE_NAME'	=> 'ناوی کووکی',
	'COOKIE_PATH'	=> 'ڕێڕەوی کووکی',
	'COOKIE_SECURE'	=> 'ئاسایشی کووکی',
