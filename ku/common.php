...
$lang = array_merge($lang, array(
	...
	'BAN_TRIGGERED_BY_EMAIL'	=> 'ڕاگرتنێک پێکهات لەسەر پۆستی ئەلیکترۆنی تۆ',
	'BAN_TRIGGERED_BY_IP'	=> 'ڕاگرتنێک پێکهات لەسەر ناونیشانی ئایپی تۆ',
	'BAN_TRIGGERED_BY_USER'	=> 'ڕاگرتنێک پێکهات لەسەر ناوی بەکارهێنەری تۆ',
	...
	'VIEWED_COUNT_NONE'	=> 'تا ئێستا نەبینراوە', // Short form for EMAIL_ADDRESS
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'بۆ بەدوورگرتنی هێرشی سەر هەژمارەکەت ،تەختاییەکە داوات کۆدی زانیاریت لێ دەکات لەدوای ژمارەیەکی زۆر لە سەرنەوکەوتن لە هاتنە ژوورەوە ،کۆدی دڵنیایی لە خوارەوە دەبێت', // unused
	'LOGIN_ERROR_ATTEMPTS'				=> 'تۆ زۆرترین ژمارەت تێپەڕاند لە هەوڵدان بۆ هاتنە ژوورەوە ،وا داوادەکرێ کۆدی دڵنیایی بەکاربەریت بۆ بەردەوامبوون',
	...
	'NEW_POST'					=> 'پەیامی نوێ',	// Not used anymore
	'NEW_POSTS'					=> 'پەیامە نوێیەکان',	// Not used anymore
	'NEXT'	=> 'داهاتوو',
	'NEXT_STEP'	=> 'داهاتوو',
	'NEVER'	=> 'هەرگیز',
	'NO'	=> 'نەخێر',
	...
	'NO_NEW_POSTS'				=> 'پەیامی نوێ نییە',	// Not used anymore
	...
	'PM'	=> 'PM',
	'PM_REPORTED'			=> 'کرتە بۆ بۆ بینینی ڕاپۆرت',
	...
	'SEND_EMAIL'	=> 'ئیمەیڵ', // Used for submit buttons
	...
	'TOO_SMALL'						=> 'بەهای نووسراو زۆر بچووکە',
	...
	'TRACKED_PHP_ERROR'	=> '%s :تۆماری هەڵەی پهپ',
	...
	'UNREAD_POST'			=> 'پەیامی نەخوێندراو',
	'UNREAD_POSTS'			=> 'پەیامە نەخوێندراوەکان',
...
$lang = array_merge($lang, array(
	'XS_SH_INFO_VERSION'	=> 'XS BBCode دیارکەری ڕستەکار بنچینەکراوە لەسەر شیکەرەوەی',
	
	'XS_SH_NOTE'				=> 'تێبینی',
	'XS_SH_TAG_ONCE'		=> 'بەکاربەریت لە واژۆیەک BBCode لەوانەیە تەنها جارێک ئەو تاگی',
	'XS_SH_TAG_SIG'			=> 'ئەو تاگە تەنها دەتوانرێت لە واژۆکان بەکارببرێت',
	'XS_SH_TAG_NOSIG'		=> 'ئەو تاگە ناتوانرێت لە واژۆکان بەکارببرێت',
	
	'XS_SH_NO_TOPIC_ID'	=> 'هیچ ناونیشانێکی بابەت نەدراوە',
	'XS_SH_NO_TOPIC'		=> 'داواکاری ناونیشانی بابەت بوونی نییە',
	'XS_SH_NO_CONTENT'	=> 'ناونیشانی بابەتی داواکراو هیچشتێک لەخۆ ناگرێت بۆ داگرتن',

	// Help lines - used if using the boardbbcodes mod
	'XS_SH_TAG_VERSION'	=> 'نیشاندانی زانیاری وەشانی BBCode : [version][/version] یان [version/]',
	'XS_SH_TAG_SYNTAX'	=> '<b>ڕستەکاری دیاریکەر</b>: [syntax="php"] کۆد لێرە [/syntax] یان [syntax lang="php" filename="file.php" start="10"] کۆد لێرە [/syntax]',
));
?>
